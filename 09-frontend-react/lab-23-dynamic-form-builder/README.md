# Lab: Dynamic Form Builder (React)
...
`schema-driven UI` · `field component registry` · `conditional field logic` · `dynamic Zod schema generation`

## Tasks

- [ ] Define a JSON field-schema format (`type, name, label, validation, visibleIf`)
- [ ] Build a field-component registry mapping `type` to the right input component
