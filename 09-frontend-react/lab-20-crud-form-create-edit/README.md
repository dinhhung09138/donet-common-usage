# Lab: CRUD Form: Create & Edit (React)
...
`shared create/edit form component` · `optimistic update` · `dirty-state guard (beforeunload/blocker)` · `form reset on entity change`
...
- [ ] Add a `useBlocker`/`beforeunload` guard warning the user about unsaved changes
