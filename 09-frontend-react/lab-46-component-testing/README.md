# Lab: Component & Unit Testing (React)
...
`Vitest/Jest` · `React Testing Library` · `MSW (Mock Service Worker)` · `testing behavior not implementation` · `coverage thresholds`

## Tasks

- [ ] Set up Vitest + React Testing Library with a jsdom environment
- [ ] Write unit tests for 2 custom hooks built in earlier labs (debounce, fetch)
