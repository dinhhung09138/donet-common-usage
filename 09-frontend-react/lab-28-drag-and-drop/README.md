# Lab: Drag-and-Drop Interactions (React)
...
`dnd-kit / react-beautiful-dnd alternative` · `sortable list` · `cross-container drop zones` · `optimistic reorder persistence` · `keyboard reorder fallback`

## Tasks

- [ ] Implement a single sortable list (drag to reorder) using `dnd-kit` or equivalent
