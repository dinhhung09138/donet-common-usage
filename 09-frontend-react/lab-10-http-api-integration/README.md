# Lab: HTTP API Integration (React)
...
`axios instance` · `interceptors` · `AbortController` · `useEffect cleanup` · `typed API layer` · `error normalization`
...
- [ ] Fetch a list in a component using `useEffect`, handling loading/error/empty states
