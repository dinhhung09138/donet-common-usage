...
- [ ] Inject `IOptionsMonitor<SmtpOptions>` into a background service; use `OnChange` callback to react to configuration changes without restart
...
- [ ] Lab completed
- [ ] PR description written → `src/05-technical-english/pr-descriptions/lab-options-pattern-pr.md`
