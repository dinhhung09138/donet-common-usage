# Lab: Charts & Dashboard Widgets (Vue)
...
`vue-chartjs/ECharts` · `responsive container` · `shared date-range filter state` · `per-widget async state` · `tooltip/legend customization`
