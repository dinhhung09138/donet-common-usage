...
`VeeValidate` · `Zod schema` · `field-level error timing` · `cross-field refine` · `server error mapping`

## Tasks

- [ ] Set up VeeValidate with a Zod schema (`toTypedSchema`) for a registration form
