...
`vue-virtual-scroller/TanStack Virtual` · `virtualization` · `column resize/reorder` · `inline cell editing` · `persisted grid layout` · `pinned columns`

## Tasks

- [ ] Render a 10,000-row dataset with row virtualization (`vue-virtual-scroller` or `@tanstack/vue-virtual`)
